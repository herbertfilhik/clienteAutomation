...
public class AutomacaoAleloCliente {
	...
	public void setUp() throws Exception {
		...
		Thread.sleep(5000);
		baseUrl = "https://calm-crag-44809.herokuapp.com";
	...
	public void AutomacaoAleloCadastroCliente_01() throws Exception {
		...
		page.setNome(nomeDiretor);
		page.setFilme(nomeFilme);
		page.setCPF(cpf);
		page.setRG(rg);
		page.setEndereco(endereco);
		page.setSalario(salario);
		page.setTelefone(telefone);
		page.setProfissao(profissao);
		page.setDescricao(descricao);
		page.setDataNascimento(dataNascimento);
		page.setDataLancamento(dataLancamento);

		System.out.println("Enviando para o Cadastro");
		page.clickBtSubmit();
		page.aguarde();

		System.out.println("Valida os dados do Cadastro");
		page.validaTextos();
		page.validaConteudo();

		System.out.println("Valida a lista do Cadastro");
		page.clickLista();
		page.aguarde();
		page.validaConteudoLista();

		System.out.println("Valida o retorno da tela inicial");
		page.clickCadastro();
		page.aguarde();
		page.validaInicial();
